@if (isset($instructor))
    @php
        $newInstructor = 0;
    @endphp
    <h5 class="title is-5"><i class="fa fa-user-circle" aria-hidden="true"></i> {{$instructor->First . " " . $instructor->Last}}</h5>
            ...
            <form method="POST" action="/instructors">
                    ...
                    <div class="field-body">
                        <div class="field">
                            <div class="control is-expanded">
                                <input class="input" type="text" id="First" name="First" placeholder="First Name" value="{{$instructor->First}}" required/>
                            </div>
                        </div>
                        <div class="field">
                            <div class="control is-expanded">
                                <input class="input" type="text" id="Last" name="Last" placeholder="Last Name" value="{{$instructor->Last}}" required/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="field is-horizontal">
                    ...
                    <div class="field-body">
                        <div class="field">
                            <div class="control is-expanded">
                                <input class="input" type="text" id="Email" name="Email" placeholder="Email" value="{{$instructor->Email}}" required />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="field-body">
                        <div class="field">
                            <div class="control">
                                ...
                                @if ($newInstructor != 1)<a class="button" href="/instructors">Cancel</a>@endif
                                </button>
                            </div>
                        </div>
                    </div>
