...
<form method="POST" action="{{ route('instructors.update', '$instructor') }}">
        ...
        <div class="field-body">
            <div class="field">
                <div class="control is-expanded">
                    <input class="input" type="text" name="First" placeholder="First Name" value="{{$instructor->First}}"  required/>
                </div>
            </div>
            <div class="field">
                <div class="control is-expanded">
                    <input class="input" type="text" name="Last" placeholder="Last Name" value="{{$instructor->Last}}" required/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="field is-horizontal">
        ...
        <div class="field-body">
            <div class="field">
                <div class="control is-expanded">
                    <input class="input" type="text" name="Display" placeholder="Display Name" value="{{$instructor->Display}}"  required/>
                </div>
            </div>
        </div>
    </div>
